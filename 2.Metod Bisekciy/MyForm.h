...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// btnSolve
			// 
			this->btnSolve->Location = System::Drawing::Point(69, 242);
			...
			// btnClear
			// 
			this->btnClear->Location = System::Drawing::Point(237, 242);
			...
			// textBoxA
			// 
			this->textBoxA->Location = System::Drawing::Point(59, 106);
			...
			// textBoxB
			// 
			this->textBoxB->Location = System::Drawing::Point(225, 106);
			...
			this->label1->Location = System::Drawing::Point(56, 70);
			...
			// textBoxTol
			// 
			this->textBoxTol->Location = System::Drawing::Point(59, 188);
			...
			this->labelResult->Location = System::Drawing::Point(56, 292);
			...
			this->label4->Location = System::Drawing::Point(222, 70);
			...
			this->label3->Text = L"Виконала Куліш Олександра";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(234, 22);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(69, 13);
			this->label5->TabIndex = 9;
			this->label5->Text = L"х^2+4 sin?х=1";
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	private: System::Void btnClear_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		labelResult->Text = "";
		   ...
		   double f(double x) {
			   // Ось наше рівняння: x^2 + 4sin(x) - 1 = 0
